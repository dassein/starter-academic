...
abstract: We study the trajectory of iterations and the convergence rates of the Expectation-Maximization (EM) algorithm for two-component Mixed Linear Regression (2MLR).
...
Our analysis provide a new framework for studying the behavior of EM for Mixed Linear Regression.
